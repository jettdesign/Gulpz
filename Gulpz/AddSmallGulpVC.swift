...
class AddSmallGulpVC: UIViewController {
    ...
    func updateText() {
        ...
        smallGulpLabel.text = "small gulp\(plural)"
    }
    
    
    @IBAction func saveSmallGulpSound(_ sender: Any) {
        ...
        Setting.currentAmount += currentAmount * Setting.smallGulp
